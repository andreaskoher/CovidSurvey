...
const regions = ["Sweden","France","Hungary","UK","USA","Italy","Germany","Denmark"]
const nregions = length(regions)
const populations = fill(1e10, nregions)
...
@kwdef struct CaseInit <: CovidSurvey.ObservationInit
    ...
    populations      ::Vector{Int64} = International.populations
end
...
function load_data(;
    ...
    covariates_kwargs = Dict(
        ...
        :fname => projectdir( homedir(), "data/covidsurvey/smoothed_contacts.csv" ),
        :shift => 0,
        :startdate => nothing,
        :enddate => nothing,
        :aggregation => 1,
    ...
    turing_data = (
        ...
        init_infected               = first.(data["cases_turing"])
        # num_i2h                     = 40,
        # ϕ_i2h                       = 5.41,
        # num_i2d                     = 60,
        # ϕ_i2d                       = 14.26,
